<%@ Page Language="C#" MasterPageFile="MasterPage.master" AutoEventWireup="true"
    CodeFile="Cadastros.aspx.cs" Inherits="Cadastros" Title="MetodologiasAgeis" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table width="100%" class="centralizado">
        ...
        <tr>
            <td>
                <asp:Button ID="btnSalvar" runat="server" Text="Salvar" class="botao" OnClick="btnSalvar_Click" />
                <asp:Button ID="btnAlterar" runat="server" Text="Alterar" class="botao" OnClick="btnAlterar_Click"
                    Visible="False" />
